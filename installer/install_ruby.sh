...
#
#  Usage:
#  Run this script without arguments to install the default Ruby version:
#      ./install_ruby.sh
#
...
#      ./install_ruby.sh VERSION PREFIX
#
#  Install without sudo (for local user installation):
#      ./install_ruby.sh VERSION PREFIX --no-sudo
#
#  Notes:
...
#
#  - By default, if no installation path is provided, Ruby will be installed under /opt/ruby/<major>.<minor>
#
