...
#
#  Usage:
#  Run this script without arguments to install the default Python version (3.13.5):
#      ./install_python.sh
#
...
#      ./install_python.sh 3.13.5 ~/.local/python --no-sudo
#
#  Notes:
#  - By default, if no installation path is provided, Python will be installed under /opt/python/x.x
#    For example, Python 3.13.5 will be installed to /opt/python/3.13
#
...
#       Default Python version 3.13.5 installs in '/opt/python/3.13' directory.
