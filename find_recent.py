...
#  The '-f' option can be used to list filenames only, without path or modification time.
#
...
def parse_arguments():
    ...
    Returns:
        ...
        filenames_only: Boolean flag indicating whether to list filenames only, without path or modification time.
    """
    ...
    # Add argument to list filenames only
    ...
    return date_arg, time_arg, args.path, args.all, args.filenames
...
def list_recent_files(root_dir, datetime_obj, include_hidden, filenames_only):
    """
    ...
    Args:
        ...
        filenames_only: A boolean indicating whether to list filenames only, without path or modification time.
    """
...
def main():
    ...
    date_arg, time_arg, path_arg, include_hidden, filenames_only = parse_arguments()
    ...
    list_recent_files(path_arg, datetime_obj, include_hidden, filenames_only)
