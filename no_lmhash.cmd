...
echo Registry Patcher - 2006 by id774 <idnanashi@gmail.com>
echo.
echo Windows でパスワードの LAN Manager ハッシュが
echo Active Directory とローカル SAM データベースに保存されないようにする
echo http://support.microsoft.com/default.aspx?scid=kb;ja;299656

set REGKey=HKLM\SYSTEM\CurrentControlSet\Control\Lsa
set REGValue=NoLMHash
...
REG ADD "\\%RemoteMachine%\%REGKey%" /v %REGValue% /t REG_DWORD /d 1 /f
echo.
