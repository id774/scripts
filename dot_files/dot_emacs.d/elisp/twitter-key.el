...
(defun switch-to-twitter6-mode ()
  (interactive)
  (twitter6-mode))
(defun switch-to-twitter-all-mode-split ()
  (interactive)
  (twitter6-mode)
  (twitter5-mode)
  (split-one-window-p)
  ...
  (twitter1-mode)
  (twitter4-mode))
(defun switch-to-twitter-all-mode-parallel ()
  (interactive)
  (twitter5-mode)
  ...
  (windmove-down)
  (twitter2-mode))
(defun switch-to-twitter-all-mode-simple ()
  (interactive)
  (twitter6-mode)
  (twitter5-mode)
  (twitter4-mode)
...
(define-key global-map "\C-c\C-c\ 7" 'switch-to-twitter-all-mode-simple)
(define-key global-map "\C-c\C-c\ 8" 'switch-to-twitter-all-mode-parallel)
(define-key global-map "\C-c\C-c\ 9" 'switch-to-twitter-all-mode-split)
