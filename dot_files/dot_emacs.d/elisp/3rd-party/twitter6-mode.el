...
;; URL: http://lambdarepos.svnrepository.com/share/trac.cgi/browser/lang/elisp/twitter6-mode
...
(if twitter6-mode-map
    (let ((km twitter6-mode-map))
      ...
      (define-key km "m" 'twitter6-retweet)
      (define-key km "\C-c\C-n" 'twitter6-naruhodius)
...
(defun twitter6-update-status-from-minibuffer (&optional init-str
							   reply-to-id)
