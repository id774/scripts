...
echo Use Osaka Font for Command Prompt
echo.

set REGKey=HKLM\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Console\TrueTypeFont
set REGValue=932.
...
REG ADD "\\%RemoteMachine%\%REGKey%" /v %REGValue% /t REG_SZ /d Osaka－等幅 /f
echo.
